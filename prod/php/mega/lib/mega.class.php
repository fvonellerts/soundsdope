...
class MEGA {
  ...
  */
  ...
  /**
  * Stream file from link.
  *
  * This operation not require authentication.
  *
  * @see public_file_info()
  */
  public function public_file_stream_from_link($link) {
    ...
    $this->public_file_stream($file['ph'], $file['key']);
  }
  ...
  */
  public function public_file_stream($ph, $key) {
  ...
  $this->file_stream_url($info['g'], $info['s'], MEGAUtil::base64_to_a32($key));
}

/**
* Stream a file node from requested temporary download URL.
*
* @param array $info
...
*/
protected function file_stream_url($url, $size, $key) {
  // Open the cipher
